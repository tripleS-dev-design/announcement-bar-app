...
const COPY = {
  ...
  es: {
    ...
    blocks: {
      ...
      announcementDesc: "Barra animada o multilingüe para captar la atención.",
      popupTitle: "Popup Premium",
      popupDesc: "Popup moderno con código promocional y efecto de brillo.",
      ...
      whatsappDesc: "Botón de contacto rápido en la esquina inferior.",
      circleTitle: "Carrusel de imágenes circulares",
      circleDesc: "Carrusel horizontal de imágenes circulares tipo stories.",
  ...
  it: {
    ...
    blocks: {
      ...
      whatsappDesc: "Pulsante di contatto rapido nell’angolo in basso.",
    ...
    whatsappPreviewDesc: "Contatto rapido — angolo in basso (mobile & desktop)",
  ...
  de: {
    ...
    heroQuote: "Mach dein Shopify-Theme attraktiver – ganz ohne Code.",
    ...
    whatsappPreviewTitle: "WhatsApp Sticky Button",
    whatsappPreviewDesc: "Schnellkontakt – Ecke unten (mobil & Desktop)",
  ...
  ar: {
    ...
    heroQuote: "اجعل متجر Shopify أكثر جاذبية بدون كتابة أي سطر من الكود.",
    ...
    blocks: {
      ...
      announcementDesc: "شريط إعلان متحرك أو متعدد اللغات لجذب الانتباه.",
      popupTitle: "نافذة منبثقة بريميوم",
      popupDesc: "بُوب أب عصري مع كود خصم و تأثير إضاءة احترافي.",
      ...
      socialDesc: "أيقونات شبكات اجتماعية مع تأثير Hover أنيق.",
      whatsappTitle: "زر واتساب عائم",
      whatsappDesc: "زر تواصل سريع في أسفل الصفحة (موبايل وكمبيوتر).",
      circleTitle: "سكرول صور دائري",
      circleDesc: "شريط أفقي لصور دائرية بشكل قصص (Stories).",
      goldTitle: "شبكة منتجات ذهبية (بريميوم)",
      goldDesc: "شبكة عرض منتجات بتصميم ذهبي من كوليكشن محدد.",
    ...
    whatsappPreviewDesc: "تواصل سريع من الزاوية السفلية (موبايل وكمبيوتر)",
    ...
    comingSoonFooter: "نضيف بلوكات جديدة بشكل منتظم، أخبرنا بما تحتاجه.",
    ...
    installPopupSubtext: "اضغط على الزر لإرسال طلبك مباشرة إلى الدعم.",
...
// ✅ Mets ici ton Crisp Website ID (le même que Home)
