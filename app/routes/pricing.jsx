...
export default function Pricing() {
  ...
  // ✅ conserve tous les params + ajoute plan=<handle> (pour chaque carte)
  ...
  // Styles communs (taille réduite)
  const cardStyle = {
    backgroundColor: "#0f0f0f",
    color: "#fff",
    padding: "24px",
    width: "320px",            // ⬅️ un peu plus petit qu'avant
    borderRadius: "12px",
  ...
  const priceStyle = { fontSize: "28px", fontWeight: "bold", margin: "10px 0" }; // ⬅️ taille réduite
  ...
  const Features = () => (
    <div
      style={{
        textAlign: "left",
        color: "#fff",
        fontSize: "13px", // ⬅️ un peu plus petit
        marginBottom: "20px",
        lineHeight: 1.5,
      }}
    >
